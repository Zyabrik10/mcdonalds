...
const firstDateCurrentMonth = new Date(currentDate.getFullYear(), currentDate.getMonth(), 1);
console.log();
// render empty days
let emptyDays = "";
for(let i = 1; i < firstDateCurrentMonth.getDay(); i++)emptyDays += "<td class='empty'></td>";
